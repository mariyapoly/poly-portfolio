        ...
        <Row className="align-items-center">
          <Col lg={7} md={7}>
            <div className="aboutme-info">
              ...
              <p>
                Myself Mst. Poly Khatun. I am a front-end developer. I am an
                enthusiastic web programmer with a passion for everything
                tech-related, from frontend to backend.{" "}
              </p>
              <p>
                I have strong skills in programming and design using the latest
                trends of technology and love working on innovative solutions to
                problems.
              </p>
              <a
                target="_blank"
